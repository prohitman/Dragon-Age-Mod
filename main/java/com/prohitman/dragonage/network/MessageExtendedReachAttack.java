...
public class MessageExtendedReachAttack implements IMessage<MessageExtendedReachAttack>
{
    ...
    @Override
  public void handle( MessageExtendedReachAttack message, 
                ...
                public void run() 
                {
                          ...
                          
                    {
                        ...
                        if (reachSq >= distanceSq)
                        {
                            ...
                            {
                                thePlayer.connection.disconnect(new TranslationTextComponent("multiplayer.disconnect.invalid_entity_attacked", new Object[0]));
